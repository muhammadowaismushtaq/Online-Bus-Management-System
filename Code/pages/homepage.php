...
<html lang="en">
  ...
  <head>
    ...
    <title>OBMS - BUS SCHEDULING SYSTEM</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top" style="background-image: linear-gradient(black, #014923);">

      <a class="navbar-brand mr-1" href="homepage.php">Menu</a>
    ...
    <div id="wrapper">
      ...
      <!-- Sidebar -->
      <ul class="sidebar navbar-nav" style="background-image: linear-gradient(black, #014923);">
        <li class="nav-item">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb"
            <li class="breadcrumb-item" style="background-image: linear-gradient();">
              <a href="homepage.php" ><h2 style= "color: #014923" > Welcome to OBMS!</h2> </a>
            </li>
          ...
          <!-- Page Content -->
          <div class="bus_logo">
            <a class="image full"><img src="../images/home.jpg" style="width:950px;" " style="background-attachment: fixed;" style="background-size: contain;"  > </a>
